...
export default function CTASection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative py-32 md:py-40 bg-[#000]"
    >
      {/* Background glow */}
      ...
      <div className="section-container relative z-10">
        ...
        <div ref={titleRef} className="text-center mb-16 md:mb-20">
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-light text-[#E9F5EC] tracking-[-2px] leading-[1.1] mb-6">
            Готовы создать
            <span className="text-[#52B788] font-medium"> магазин</span>?
          </h2>
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          <form
            ...
            className="lg:col-span-3 p-8 md:p-10 rounded-2xl border border-[#2D6A4F]/30 bg-[#1B4332]/30 backdrop-blur-sm"
          >
            {submitted ? (
              ...
              <>
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      className="w-full px-4 py-3 rounded-xl bg-[#1B4332]/80 border border-[#2D6A4F]/40 text-[#E9F5EC] placeholder-[#E9F5EC]/30 focus:outline-none focus:border-[#52B788] transition-colors"
                ...
                <div className="mb-8">
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 rounded-xl bg-[#1B4332]/80 border border-[#2D6A4F]/40 text-[#E9F5EC] placeholder-[#E9F5EC]/30 focus:outline-none focus:border-[#52B788] transition-colors resize-none"
                    placeholder="Расскажите о вашем проекте, товарах и целях..."
                  />
                </div>

                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#F0B95A] text-[#000] font-medium rounded-full hover:bg-[#F0B95A]/90 transition-all duration-300 hover:scale-[1.02]"
                >
                  <Send className="w-5 h-5" />
                  Отправить заявку
                </button>

                <p className="text-[#E9F5EC]/30 text-xs text-center mt-4">
          ...
          {/* Contact Info */}
          <div ref={infoRef} className="lg:col-span-2 flex flex-col justify-center gap-8">
            <div>
              <h3 className="text-xl font-medium text-[#E9F5EC] mb-4">Контакты</h3>
              <div className="space-y-4">
                <a
                  href="tel:+74951234567"
                  className="flex items-center gap-3 text-[#E9F5EC]/70 hover:text-[#52B788] transition-colors"
                >
                  <Phone className="w-5 h-5" />
                  <span>+7 (495) 123-45-67</span>
                </a>
                <a
                  href="mailto:hello@kitpro.ru"
                  className="flex items-center gap-3 text-[#E9F5EC]/70 hover:text-[#52B788] transition-colors"
                >
                  <Mail className="w-5 h-5" />
                  <span>hello@kitpro.ru</span>
                </a>
                <div className="flex items-start gap-3 text-[#E9F5EC]/70">
                  <MapPin className="w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span>Москва, ул. Дизайнерская, 42<br />Бизнес-центр «Технопарк»</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-xl border border-[#2D6A4F]/30 bg-[#1B4332]/30">
              ...
              <p className="text-[#E9F5EC]/50 text-sm mb-4">
                Получите бесплатный аудит вашей текущей площадки и рекомендации по улучшению
              </p>
              <div className="flex items-center gap-2 text-[#52B788] text-sm">
            ...
            <div className="p-6 rounded-xl border border-[#F0B95A]/20 bg-[#F0B95A]/5">
              ...
              <p className="text-[#E9F5EC]/60 text-sm">
                При заказе до конца месяца — бесплатная настройка Яндекс.Метрики и целей на 3 месяца
              </p>
            </div>
          </div>
        </div>
